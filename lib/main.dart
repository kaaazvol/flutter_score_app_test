          ...
          Container(
            ...
            child: Row(
              children: [
                ...
                Expanded(child:
                Text(
                  total_decision_rate.toStringAsFixed(1),
                  style: TextStyle(
                    fontSize: 20,
                  ),
                ),
          ...
          Container(
            ...
            child: Row(
              children: [
                ...
                Expanded(child:
                Text(
                  //rece_decision_rate.toStringAsFixed(1)+'%',
                  rece_decision_rate.toStringAsFixed(1),
                  style: TextStyle(
                    fontSize: 20,
                  ),
          ...
          Container(
            ...
            Row(
              children: [
                ...
                Expanded(child:
                Text(
                  trans_decision_rate.toStringAsFixed(1),
                  style: TextStyle(
                    fontSize: 20,
                  ),
                ),
          ...
          Container(
            ...
            Row(
              children: [
                ...
                Expanded(child:
                  Text(
                    back_decision_rate.toStringAsFixed(1),
                    style: TextStyle(
                      fontSize: 20,
                    ),
                  ),
...
//============================================
//DigScoreMainPage
class DigScoreMainPage extends StatelessWidget {
  const DigScoreMainPage({super.key});
...
class DigPlayerRecord extends StatefulWidget {
  //PlayerRecord({required Key key}) : super(key: key);

  @override
  _DigPlayerRecord createState() => _DigPlayerRecord();

}

class _DigPlayerRecord extends State<DigPlayerRecord> {
  //ディグ（強）の変数
  int dig_stro_sum_number = 0;
  int dig_stro_decision_number = 0;
  int dig_stro_failure_number = 0;
  double dig_stro_decision_rate = 0.0;
  //ディグ（軟）の変数
  int dig_soft_sum_number = 0;
  int dig_soft_decision_number = 0;
  int dig_soft_failure_number = 0;
  double dig_soft_decision_rate = 0.0;
  //トータルアタックの変数
  int onetouch_sum_number = 0;
  int onetouch_decision_number = 0;
  int onetouch_failure_number = 0;
  double onetouch_decision_rate = 0.0;
  //undo用の変数
  String undo_string = "";
  ...
  //ディグ（強）の関数
  //決定数のカウントアップ関数
  void _incrementDigStrongDecisionNumber() {
    // Widget再構築部分
    setState(() {
      //合計数のカウントアップ
      dig_stro_sum_number++;
      //決定数のカウントアップ
      dig_stro_decision_number++;
      //決定率の計算
      dig_stro_decision_rate = (dig_stro_decision_number / dig_stro_sum_number)*100;
      //undo用の変数を更新
      undo_string = "dig_stro_decision_number";
    });
  }
  //失敗のカウントアップ関数
  void _incrementDigStrongFailureNumber() {
    // Widget再構築部分
    setState(() {
      //合計数のカウントアップ
      dig_stro_sum_number++;
      //失敗数のカウントアップ
      dig_stro_failure_number++;
      //決定率の計算
      dig_stro_decision_rate = (dig_stro_decision_number / dig_stro_sum_number)*100;
      //undo用の変数を更新
      undo_string = "dig_stro_failure_number";
    });
  }
  //===============================================
  //ディグ（軟）の関数
  //決定数のカウントアップ関数
  void _incrementDigSoftDecisionNumber() {
    // Widget再構築部分
    setState(() {
      //合計数のカウントアップ
      dig_soft_sum_number++;
      //決定数のカウントアップ
      dig_soft_decision_number++;
      //決定率の計算
      dig_soft_decision_rate = (dig_soft_decision_number / dig_soft_sum_number)*100;
      //undo用の変数を更新
      undo_string = "dig_soft_decision_number";
    });
  }
  //失敗のカウントアップ関数
  void _incrementDigSoftFailureNumber() {
    // Widget再構築部分
    setState(() {
      //合計数のカウントアップ
      dig_soft_sum_number++;
      //失敗数のカウントアップ
      dig_soft_failure_number++;
      //決定率の計算
      dig_soft_decision_rate = (dig_soft_decision_number / dig_soft_sum_number)*100;
      //undo用の変数を更新
      undo_string = "dig_soft_failure_number";
    });
  }
  //===============================================
  //ワンタッチボールの関数
  //決定数のカウントアップ関数
  void _incrementOnetouchDecisionNumber() {
    // Widget再構築部分
    setState(() {
      //合計数のカウントアップ
      onetouch_sum_number++;
      //決定数のカウントアップ
      onetouch_decision_number++;
      //決定率の計算
      onetouch_decision_rate = (onetouch_decision_number / onetouch_sum_number)*100;
      //undo用の変数を更新
      undo_string = "onttouch_decision_number";
    });
  }
  //失敗のカウントアップ関数
  void _incrementOnetouchFailureNumber() {
    // Widget再構築部分
    setState(() {
      //合計数のカウントアップ
      onetouch_sum_number++;
      //失敗数のカウントアップ
      onetouch_failure_number++;
      //決定率の計算
      onetouch_decision_rate = (onetouch_decision_number / onetouch_sum_number)*100;
      //undo用の変数を更新
      undo_string = "onttouch_failure_number";
    });
  }
  //===============================================
  //上で書いたカウントアップ関数と逆の処理を行う
  void _undo() {
    setState(() {
      //ディグ（強）
      if (undo_string.startsWith("dig_stro")) {
        if (undo_string == "dig_stro_decision_number") {
          //合計数のカウントダウン
          dig_stro_sum_number--;
          //決定数のカウントダウン
          dig_stro_decision_number--;
        ...
        //ディグ（軟）
      } else if (undo_string.startsWith("dig_soft")) {
        if (undo_string == "dig_soft_decision_number") {
          //合計数のカウントダウン
          dig_soft_sum_number--;
          //決定数のカウントダウン
          dig_soft_decision_number--;
        ...
        if (undo_string == "onttouch_decision_number") {
          //合計数のカウントダウン
          onetouch_sum_number--;
          //決定数のカウントダウン
          onetouch_decision_number--;
          ...
          Container(
            ...
            child: Row(
              children: [
                ...
                Expanded(child:
                  Container(
                    ...
                    child: GestureDetector(
                      //ボタンが押されたときの関数
                      //カウントアップを行う
                      onTap: _incrementDigStrongDecisionNumber,
                      //数を表示する
                      child: Text('$dig_stro_decision_number',
                        style: TextStyle(
                        fontSize: 26,
                        ),
                      ),
                ...
                Expanded(child:
                  Container(
                    ...
                    child: GestureDetector(
                      //ボタンが押されたときの関数
                      //カウントアップを行う
                      onTap: _incrementDigStrongFailureNumber,
                      //数を表示する
                      child: Text('$dig_stro_failure_number',
                        style: TextStyle(
                        fontSize: 26,
                        ),
                      ),
                ...
                Text(
                  //rece_decision_rate.toStringAsFixed(1)+'%',
                  dig_stro_decision_rate.toStringAsFixed(1),
                  style: TextStyle(
                    fontSize: 24,
                  ),
                ),
            ...
            child: Row(
              children: [
                ...
                Expanded(child:
                  Container(
                    ...
                    child: GestureDetector(
                      //ボタンが押されたときの関数
                      //カウントアップを行う
                      onTap: _incrementDigSoftDecisionNumber,
                      //数を表示する
                      child: Text('$dig_soft_decision_number',
                        style: TextStyle(
                        fontSize: 26,
                        ),
                      ),
                ...
                Expanded(child:
                  Container(
                    ...
                    child: GestureDetector(
                      //ボタンが押されたときの関数
                      //カウントアップを行う
                      onTap: _incrementDigSoftFailureNumber,
                      //数を表示する
                      child: Text('$dig_soft_failure_number',
                        style: TextStyle(
                        fontSize: 26,
                        ),
                      ),
                ...
                Expanded(child:
                  Text(
                    //rece_decision_rate.toStringAsFixed(1)+'%',
                    dig_soft_decision_rate.toStringAsFixed(1),
                    style: TextStyle(
                      fontSize: 24,
                    ),
                  ),
          ...
          Container(
            ...
            Row(
              children: [
                ...
                Expanded(child:
                  Container(
                    ...
                    child: GestureDetector(
                      //ボタンが押されたときの関数
                      //カウントアップを行う
                      onTap: _incrementOnetouchDecisionNumber,
                      //数を表示する
                      child: Text('$onetouch_decision_number',
                        style: TextStyle(
                        fontSize: 26,
                        ),
                      ),
                ...
                Expanded(child:
                  Container(
                    ...
                    child: GestureDetector(
                      //ボタンが押されたときの関数
                      //カウントアップを行う
                      onTap: _incrementOnetouchFailureNumber,
                      //数を表示する
                      child: Text('$onetouch_failure_number',
                        style: TextStyle(
                        fontSize: 26,
                        ),
                      ),
                ...
                Expanded(child:
                  Text(
                    onetouch_decision_rate.toStringAsFixed(1),
                    style: TextStyle(
                      fontSize: 24,
                    ),
                  ),
              ...
              Expanded(child:
                Container(
                  ...
                  child: Row(
                    children: [
                      //プレイヤーの名前を記入
                      Container(width:91.5, child: TextField()),
                      Expanded(child:
                      OtherPlayerRecord(),
                      ),
                    ],
              ...
              children: [
                ...
                Container(
                  ...
                  child: GestureDetector(
                    ...
                    //数を表示する
                    child: Text('$serve_decision_number',
                      style: TextStyle(
                        fontSize: 26,
                      ),
                    ),
                ...
                Container(
                  ...
                  child: GestureDetector(
                    ...
                    //数を表示する
                    child: Text('$serve_effective_number',
                      style: TextStyle(
                        fontSize: 26,
                      ),
                    ),
                ...
                Container(
                  ...
                  child: GestureDetector(
                    ...
                    //数を表示する
                    child: Text('$serve_failure_number',
                      style: TextStyle(
                        fontSize: 26,
                      ),
                    ),
                ...
                Text(
                  //rece_decision_rate.toStringAsFixed(1)+'%',
                  serve_decision_rate.toStringAsFixed(1),
                  style: TextStyle(
                    fontSize: 24,
                  ),
                ),
              ...
              children: [
                ...
                Container(
                  ...
                  child: GestureDetector(
                    ...
                    //数を表示する
                    child: Text('$block_decision_number',
                      style: TextStyle(
                        fontSize: 26,
                      ),
                    ),
                ...
                Container(
                  ...
                  child: GestureDetector(
                    ...
                    //数を表示する
                    child: Text('$block_failure_number',
                      style: TextStyle(
                        fontSize: 26,
                      ),
                    ),
                ...
                Expanded(child:
                Text(
                  block_decision_rate.toStringAsFixed(1),
                  style: TextStyle(
                    fontSize: 24,
                  ),
                ),
              ...
              children: [
                ...
                Container(
                  ...
                  child: GestureDetector(
                    ...
                    //数を表示する
                    child: Text('$highset_decision_number',
                      style: TextStyle(
                        fontSize: 26,
                      ),
                    ),
                ...
                Container(
                  ...
                  child: GestureDetector(
                    ...
                    //数を表示する
                    child: Text('$highset_connection_number',
                      style: TextStyle(
                        fontSize: 26,
                      ),
                    ),
                ...
                Container(
                  ...
                  child: GestureDetector(
                    ...
                    //数を表示する
                    child: Text('$highset_failure_number',
                      style: TextStyle(
                        fontSize: 26,
                      ),
                    ),
                ...
                Text(
                  //rece_decision_rate.toStringAsFixed(1)+'%',
                  highset_decision_rate.toStringAsFixed(1),
                  style: TextStyle(
                    fontSize: 24,
                  ),
                ),
